...
class LMModel(StreamingModule):
    ...
    def __init__(self, pattern_provider: CodebooksPatternProvider, condition_provider: ConditioningProvider,
        ...
        print("cfg_dropout:", cfg_dropout, "att_dropout:", attribute_dropout)
    ...
    def generate(self,
        ...
        if conditions:
            ...
            if two_step_cfg:
                ...
                # pdb.set_trace()
                wav_path = conditions[0]['text']['meta'].path
                conditions = conditions + null_conditions
                tokenized = self.condition_provider.tokenize(conditions)
                cfg_conditions = self.condition_provider(tokenized, wav_path)
        else:
            cfg_conditions = {}
